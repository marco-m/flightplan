...
- Perform many consistency checks before hitting the Concourse server. This can be coupled to great advantage with Open Policy Agent, that is supported by Concourse.
